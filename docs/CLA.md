# Individual Contributor License Agreement (v1.0, Nebula)
...
past and future "Contributions" submitted to the **Nebula project
(the "Project")**.
...
You grant **Gravitrone** and all recipients of software distributed by the
...
You grant **Gravitrone** and all recipients of the Project a perpetual,
